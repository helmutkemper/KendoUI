<?php
   ...
   */
  class KendoUiComboBox extends javascript
  {
    private $outputCStr;
    ...
    public function toJavaScriptOutput ()
    {
      ...
      self::$mainJavaScriptCodeCStr .= "$(\"#{$this->idElementCStr}\").KendoUiComboBox({";
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-animation
     * 
     * @code
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-animation.close
     * 
     * @code
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-animation.open
     * 
     * @code
       Example - configure the close animation
        <input id="combobox" />
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-animation.close.effects
     * 
     * The duration of the close animation in milliseconds.
     * @var $dataAX[ 'animation' ][ 'close' ][ 'duration' ]: ( Number ) ( default: 100 )
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-animation.close.duration
     * 
     * The effect(s) to use when playing the open animation. Multiple effects should be separated with a space.
     * <a href="/kendo-ui/api/framework/fx/common">Complete list of available animations</a>
     * @var $dataAX[ 'animation' ][ 'open' ][ 'effects' ]: ( String )
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-animation.open.effects
     * 
     * The duration of the open animation in milliseconds.
     * @var $dataAX[ 'animation' ][ 'open' ][ 'duration' ]: ( Number ) ( default: 200 )
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-animation.open.duration
    ...
    public function animation ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::animation ( \$data[ 'animation' ][ 'close' ][ 'effects' ] type must be 'String'" );
      }
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::animation ( \$data[ 'animation' ][ 'close' ][ 'duration' ] type must be 'Number'" );
      }
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::animation ( \$data[ 'animation' ][ 'open' ][ 'effects' ] type must be 'String'" );
      }
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::animation ( \$data[ 'animation' ][ 'open' ][ 'duration' ] type must be 'Number'" );
      }
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::animation ( \$data[ 'animation' ][ 'close' ] type must be 'Object'" );
      }
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::animation ( \$data[ 'animation' ][ 'open' ] type must be 'Object'" );
      }
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::animation ( \$data[ 'animation' ] type must be 'Object'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-autoBind
     * 
     * @code
       Example
        <input id="combobox" />
    ...
    public function autoBind ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::autoBind ( \$data[ 'autoBind' ] type must be 'Boolean'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-cascadeFrom
     * 
     * @code
       Example
        <input id="parent" />
    ...
    public function cascadeFrom ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::cascadeFrom ( \$data[ 'cascadeFrom' ] type must be 'String'" );
      }
    ...
    /**
     * Defines the field to be used to filter the data source. If not defined the <a href="/kendo-ui/api/web/combobox#configuration-dataValueField">parent's dataValueField option will be used</a>. <a href="/kendo-ui/web/combobox/cascading">Help topic showing how cascading functionality works</a>
     * @var $dataAX[ 'cascadeFromField' ]: ( String )
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-cascadeFromField
     * 
     * @code
       Example
        <input id="parent" />
    ...
    public function cascadeFromField ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::cascadeFromField ( \$data[ 'cascadeFromField' ] type must be 'String'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-dataSource
     * 
     * @code
    ...
    public function dataSource ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::dataSource ( \$data[ 'dataSource' ] type must be 'Object' | 'Array' | 'kendo.data.DataSource'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-dataTextField
     * 
     * @code
    ...
    public function dataTextField ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::dataTextField ( \$data[ 'dataTextField' ] type must be 'String'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-dataValueField
     * 
     * @code
    ...
    public function dataValueField ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::dataValueField ( \$data[ 'dataValueField' ] type must be 'String'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-delay
     * 
     * @code
    ...
    public function delay ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::delay ( \$data[ 'delay' ] type must be 'Number'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-enable
     * 
     * @code
    ...
    public function enable ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::enable ( \$data[ 'enable' ] type must be 'Boolean'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-filter
     * 
     * @code
    ...
    public function filter ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::filter ( \$data[ 'filter' ] type must be 'String'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-fixedGroupTemplate
     * 
     * @code
    ...
    public function fixedGroupTemplate ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::fixedGroupTemplate ( \$data[ 'fixedGroupTemplate' ] type must be 'String' | 'Function'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-groupTemplate
     * 
     * @code
    ...
    public function groupTemplate ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::groupTemplate ( \$data[ 'groupTemplate' ] type must be 'String' | 'Function'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-height
     * 
     * @code
    ...
    public function height ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::height ( \$data[ 'height' ] type must be 'Number'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-highlightFirst
     * 
     * @code
    ...
    public function highlightFirst ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::highlightFirst ( \$data[ 'highlightFirst' ] type must be 'Boolean'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-ignoreCase
     * 
     * @code
    ...
    public function ignoreCase ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::ignoreCase ( \$data[ 'ignoreCase' ] type must be 'String'" );
      }
     ...
     * @var $dataAX[ 'index' ]: ( Number ) ( default: -1 )
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-index
     * 
     * @code
    ...
    public function index ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::index ( \$data[ 'index' ] type must be 'Number'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-minLength
     * 
     * @code
    ...
    public function minLength ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::minLength ( \$data[ 'minLength' ] type must be 'Number'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-placeholder
     * 
     * @code
    ...
    public function placeholder ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::placeholder ( \$data[ 'placeholder' ] type must be 'String'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-popup
     * 
     * @code
    ...
    public function popup ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::popup ( \$data[ 'popup' ] type must be 'Object'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-suggest
     * 
     * @code
    ...
    public function suggest ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::suggest ( \$data[ 'suggest' ] type must be 'Boolean'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-headerTemplate
     * 
     * @code
    ...
    public function headerTemplate ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::headerTemplate ( \$data[ 'headerTemplate' ] type must be 'String' | 'Function'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-template
     * 
     * @code
    ...
    public function template ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::template ( \$data[ 'template' ] type must be 'String' | 'Function'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-text
     * 
     * @code
    ...
    public function text ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::text ( \$data[ 'text' ] type must be 'String'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-value
     * 
     * @code
    ...
    public function value ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::value ( \$data[ 'value' ] type must be 'String'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-valuePrimitive
     * 
     * @code
    ...
    public function valuePrimitive ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::valuePrimitive ( \$data[ 'valuePrimitive' ] type must be 'Boolean'" );
      }
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-virtual
     * 
     * @code
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-virtual.itemHeight
     * 
     * @code
     ...
     * @see http://docs.telerik.com/kendo-ui/api/javascript/ui/combobox#configuration-virtual.valueMapper
     * 
     * @code
    ...
    public function virtual ( $dataAX )
    {
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::virtual ( \$data[ 'virtual' ][ 'itemHeight' ] type must be 'Number'" );
      }
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::virtual ( \$data[ 'virtual' ][ 'valueMapper' ] type must be 'Function'" );
      }
      ...
      {
        throw new Exception ( "Type error - KendoUiComboBox::virtual ( \$data[ 'virtual' ] type must be 'Boolean' | 'Object'" );
      }
